...
class Logger {
     ...
     */
    public function __construct($directorio = null, $tamañoMaximo = 5242880, $nivel_minimo = null) {
        if ($directorio === null) {
        ...
        // Determinar nivel mínimo según el entorno
...
/**
 * Función helper para acceder al logger globalmente
 * @return Logger
 */
function logger() {
    global $logger;
