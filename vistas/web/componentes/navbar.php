    ...
    <div class="h-[120px] flex items-center justify-between px-[7%] w-full">
        ...
        <div class="flex-1 flex flex-col items-center justify-end gap-2">
            ...
            <div class="flex gap-[40px] items-center justify-end w-full pr-0">
                <!-- Webinars -->
                <a href="#" class="font-montserrat font-medium text-sm text-[#553cc8] uppercase hover:opacity-80 transition-opacity">
                    Webinars
                </a>
            ...
            <div class="flex gap-[60px] items-center justify-end w-full pr-0">
                ...
                <a href="#" class="flex gap-[10px] items-center hover:opacity-80 transition-opacity">
                ...
                <!-- Tienda -->
                <a href="#" class="font-montserrat font-medium text-base text-[#553cc8] uppercase whitespace-nowrap hover:opacity-80 transition-opacity">
                    Tienda
                </a>
        ...
        <div class="flex flex-col items-center gap-1 flex-shrink-0 ml-20">
            ...
            <div class="w-16 h-16 rounded-full overflow-hidden bg-gradient-to-r from-[#ff3d81] to-[#0064ff] flex items-center justify-center hover:opacity-90 transition-opacity flex-shrink-0">
                <img src="<?=importAsset('profile-picture.svg')?>" alt="Perfil" class="w-full h-full object-cover">
            </div>
            
            <!-- Iniciar Sesión button -->
            <a href="#" class="font-montserrat font-bold text-[10px] text-[#0064ff] uppercase hover:text-[#0050cc] transition-colors whitespace-nowrap">
                Iniciar sesión
            </a>
        </div>
    </div>
...
<div id="mobile-menu" class="xl:hidden hidden fixed top-16 left-0 w-screen h-[calc(100vh-64px)] bg-white z-40 flex flex-col overflow-y-auto">
    ...
    <nav class="flex flex-col items-center gap-5 px-4 mt-8 flex-shrink-0">
        <!-- Diplomado with dropdown -->
        <a href="#" class="flex gap-2 items-center hover:opacity-80 transition-opacity">
        ...
        <!-- Tienda -->
        <a href="#" class="font-montserrat font-medium text-base text-[#553cc8] uppercase hover:opacity-80 transition-opacity">
            Tienda
        </a>
    ...
    <div class="flex flex-col items-center gap-3 mt-auto mb-12 flex-shrink-0">
        <!-- Profile Picture Circle -->
        <div class="w-20 h-20 rounded-full overflow-hidden bg-gradient-to-r from-[#ff3d81] to-[#0064ff] flex items-center justify-center hover:opacity-90 transition-opacity flex-shrink-0">
            <img src="<?=importAsset('profile-picture.svg')?>" alt="Perfil" class="w-full h-full object-cover">
        </div>
        
        <!-- Iniciar Sesión button -->
        <a href="#" class="font-montserrat font-bold text-sm text-[#0064ff] uppercase hover:text-[#0050cc] transition-colors">
            Iniciar sesión
        </a>
    </div>
