<nav class="navbarDiscreto fixed top-0 left-0 w-screen overflow-x-clip transiution-all duration-500 z-50" 
     data-bg-class="bg-slate-500" 
     data-shadow-class="shadow-xl">
    ...
    <ul id="menu" onclick="toggleMobileMenu()" class="flex-col fixed top-0 left-0 w-screen text-slate-900 bg-black bg-opacity-80 h-screen z-50 transform translate-x-full transition-transform duration-300 lg:hidden">
        <li class="border-b-2 border-black bg-white hover:bg-gray-200">
            <a href="<?=ruta('')?>"
            class="w-full h-full py-6 duration-500 flex items-center justify-center text-center text-[40px] hover:scale-110">Home</a>
        </li>
        <li class="border-b-2 border-black bg-white hover:bg-gray-200">
            <a href="<?=ruta('pagina2')?>"
            class="w-full h-full py-6 duration-500 flex items-center justify-center text-center text-[40px] hover:scale-110">Página 2</a>
        </li>
        <li class="border-b-2 border-black bg-white hover:bg-gray-200">
            <a href="<?=ruta('pagina3')?>"
            class="w-full h-full py-6 duration-500 flex items-center justify-center text-center text-[40px] hover:scale-110">Página 3</a>
        </li>
        <li class="border-b-2 border-black bg-white hover:bg-gray-200">
            <a href="<?=ruta('contacto')?>"
            class="w-full h-full py-6 duration-500 flex items-center justify-center text-center text-[40px] hover:scale-110">Contacto</a>
        </li>
        <?php $telefono = configuracion('telefono'); if ($telefono): ?>
        <li class="border-b-2 border-black bg-white hover:bg-gray-200">
            <a href="tel:<?= htmlspecialchars($telefono) ?>"
