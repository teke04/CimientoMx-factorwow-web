...
<html lang="ES">
<?php 
$titulo = 'Página 2 - ' . env('EMPRESA');
$descripcion = 'Bienvenido a la página 2 de ' . env('EMPRESA') . '. Descubre nuestros servicios y cómo podemos ayudarte a alcanzar tus objetivos.';
?>
<head> 
...
<body class="w-screen overflow-x-clip">
    ...
    <main>
        ...
        <section class="w-screen h-screen flex items-center justify-center relative">
            <h1 class="text-[90px]">PAGINA 2</h1>
        </section>
